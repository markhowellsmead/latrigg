...
<div class="wp-block-query"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|regular"}},"className":"c-archive__header"} -->
	...
	<div class="wp-block-group"><!-- wp:paragraph {"align":"center","placeholder":"Add text or blocks that will display when a query returns no results."} -->
		...
		<figure class="wp-block-image alignwide size-large"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/20230528-DSCF2758-edited-1280x720.webp" alt="Poppies in north-western Switzerland" class="wp-image-72611" /></figure>
		<!-- /wp:image -->
	</div>
	<!-- /wp:group -->
	<!-- /wp:query-no-results -->

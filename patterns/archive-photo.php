...
<main class="wp-block-group c-main">
	...
	<div class="wp-block-query">
		<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|xlarge"}},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-group">
				<!-- wp:sht/primary-media {"hideInlineEmbed":true,"resolution":"thumbnail","className":"is-style-3x2"} /-->
				...
				<div
					...
					<div class="wp-block-column" style="flex-basis: 30%">
						<!-- wp:post-date {"textAlign":"right","format":"M Y","style":{"elements":{"link":{"color":{"text":"var:preset|color|gray"}}}},"textColor":"gray","fontSize":"small"} /-->
					</div>
					<!-- /wp:column -->
				</div>
				<!-- /wp:columns -->
